import {lowercaseFirst, uppercaseFirst, truncate, space, splitMapJoin} from '../../../_api';
...
describe('node - logic:types:string', () => {
  ...
  test('logic:types:string:splitMapJoin', () => {
    ...
    expect(splitMapJoin(str, space, substring => substring.toUpperCase())).toBe(str.toUpperCase());
  });
});

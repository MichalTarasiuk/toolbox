 ...
 */
export const objectKeys = <Object extends Any.AnyObject, Type extends 'strict' | undefined = undefined>(
  object: Object,
  _?: Type,
) =>
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions -- safety assertion
  Object.keys(object) as Type extends undefined ? Array<keyof Object> : ObjectType.Keys<Object>;
 ...
 */
export const entries = <Object extends Any.AnyObject>(object: Custom.Narrow<Object>) =>
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions -- safety assertion
 ...
 */
export const fromEntries = <Entries extends Array<[PropertyKey, unknown]>>(entries: Custom.Narrow<Entries>) =>
  // eslint-disable-next-line @typescript-eslint/consistent-type-assertions -- safety assertion

...
const createTree = (initialContextValue: ContextValue) => {
  const [SelectorContextProvider, useSelectorContext] = createSelectorContext<ContextValue>('tree');
  ...
  const OptionalSelectorContextProvider = (props: SelectorContextProviderProps) => {
